...
test.describe('Register', () => {
   ...
   * @tags {regression}
   */
  test('POST Request - Register Successful. @regression', async ({ request }: { request: APIRequestContext }) => {
   ...
   * @tags {regression}
   */
  test('POST Request - Register Unsuccessful. @regression', async ({ request }: { request: APIRequestContext }) => {
