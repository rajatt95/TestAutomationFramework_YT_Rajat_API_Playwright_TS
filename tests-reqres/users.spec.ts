...
test.describe('Users', () => {
   ...
   * @tags {regression}
   */
  test('GET Request - SINGLE USER NOT FOUND. @regression', async ({ request }: { request: APIRequestContext }) => {
   ...
   * @tags {regression}
   */
  test('GET Request - LIST USERS. @regression', async ({ request }: { request: APIRequestContext }) => {
   ...
   * @tags {regression, sanity}
   */
  test('PATCH Request - Update User. @regression @sanity', async ({ request }: { request: APIRequestContext }) => {
